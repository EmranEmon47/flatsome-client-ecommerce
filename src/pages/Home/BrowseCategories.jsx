...
const BrowserCategories = () => {
  ...
  return (
    <div className="relative w-full lg:max-w-[calc(100%-440px)] mx-auto">
      {/* Red glow top */}
      <div className="pointer-events-none hidden lg:block absolute top-[-50px] left-[-50px] h-60 w-60 dark:bg-red-500 bg-none opacity-30 rounded-full blur-3xl"></div>

      {/* Red glow bottom right */}
      <div className="pointer-events-none hidden lg:block absolute bottom-[-50px] right-[-50px] h-72 w-72 dark:bg-red-500 bg-none opacity-30 rounded-full blur-3xl"></div>
      {/* Heading */}
